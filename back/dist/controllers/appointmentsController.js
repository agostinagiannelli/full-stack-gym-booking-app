    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4, (0, appointmentService_1.scheduleAppointmentService)(appointment)];
            case 1:
                newAppointment = _a.sent();
                res.status(201).json({ message: "Appointment scheduled", newAppointment: newAppointment });
                return [3, 3];
            case 2:
                error_3 = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4, (0, appointmentService_1.cancelAppointmentService)(Number(id))];
            case 1:
                appointment = _a.sent();
                res.status(200).json({ message: "Appointment cancelled", appointment: appointment });
                return [3, 3];
            case 2:
                error_4 = _a.sent();
